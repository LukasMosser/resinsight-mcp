...
This section contains the development workflow and proposed design.
The repository contains a foundation, with no application implementation.
Design descriptions do not establish working integration or simulator support.
